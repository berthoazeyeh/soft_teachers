...
const HeaderDashBoad = ({ navigation, children, theme, componend }: Props): React.JSX.Element => {
    ...
    return (<View>
        ...
        <View style={styles.headerContent}>
            ...
            >
                <Text style={{ color: theme.secondaryText, fontSize: 20 }}>
                    <MaterialCommunityIcons name={"account"} size={30} color={theme.secondaryText} />
                </Text>
            </View>
            <View style={styles.headerContentText}>
                <Text style={styles.title}> {children?.name || children?.student?.name || " "}</Text>
            </View>
        </View>
