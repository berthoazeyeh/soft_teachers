...
const DateAndNotesPickerSubExams = ({ canEdit, exam, form }: { canEdit: boolean, exam: any, form: any }) => {
                ...
                render={({ field, fieldState }) => (
                    <>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <Text style={{ ...Theme.fontStyle.montserrat.semiBold, color: theme.primaryText, fontSize: 15, }}>{GradeEntryText.sub_exam_name}</Text>
                            <TextInput
                                style={styles.input}
                                editable={canEdit}
                                maxLength={100}
                ...
                render={({ field, fieldState }) => (
                    <>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <Text style={{ ...Theme.fontStyle.montserrat.semiBold, color: theme.primaryText, fontSize: 15, }}>{GradeEntryText.new_sub_exam_weigth}</Text>
                            <TextInput
                                style={styles.input}
                                editable={canEdit}
                                textAlign='center'
...
export default DateAndNotesPickerSubExams;
